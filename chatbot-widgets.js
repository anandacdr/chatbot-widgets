(function() {
    ...
    // Apply widget styles with responsive and accessible design
    ...
    widgetStyles.textContent = `
        .chat-assist-widget {
            ...
            --chat-color-text-light: var(--chat-widget-text-light, #4b5563);
    ...
    chatWindow.setAttribute('aria-labelledby', 'chat-header-title');
    ...
    const welcomeScreenHTML = `
        <div class="chat-header">
            ...
            <span class="chat-header-title" id="chat-header-title">${settings.branding.name}</span>
            <button class="chat-close-btn" aria-label="Close chat window">×</button>
        </div>
        <div class="chat-welcome">
            <h2 class="chat-welcome-title">${settings.branding.welcomeText}</h2>
            <button class="chat-start-btn" aria-label="Start chatting">
        ...
        <div class="user-registration">
            ...
            <form class="registration-form">
                <div class="form-field">
                    ...
                    <input type="text" id="chat-user-name" class="form-input" placeholder="Your name" required aria-describedby="name-error">
                    <div class="error-text" id="name-error"></div>
                </div>
                <div class="form-field">
                    <label class="form-label" for="chat-user-email" style="color: black;">Email</label>
                    <input type="email" id="chat-user-email" class="form-input" placeholder="Your email address" required aria-describedby="email-error">
    ...
    const chatInterfaceHTML = `
        <div class="chat-body">
            ...
            <div class="chat-controls">
                <textarea class="chat-textarea" placeholder="Type your message here..." rows="1" aria-label="Type your message"></textarea>
    ...
    async function submitMessage(messageText) {
        ...
        const messageNodes = messagesContainer.querySelectorAll('.chat-bubble, .suggested-questions, .typing-indicator');
        if (messageNodes.length > maxMessages) {
            for (let i = 0; i < messageNodes.length - maxMessages; i++) {
                messagesContainer.removeChild(messageNodes[i]);
            }
        }
        ...
        try {
            ...
            // Re-check message limit after adding bot message
            const updatedMessageNodes = messagesContainer.querySelectorAll('.chat-bubble, .suggested-questions, .typing-indicator');
            if (updatedMessageNodes.length > maxMessages) {
                for (let i = 0; i < updatedMessageNodes.length - maxMessages; i++) {
                    messagesContainer.removeChild(updatedMessageNodes[i]);
                }
            }
    ...
    launchButton.addEventListener('click', () => {
        ...
        launchButton.setAttribute('aria-expanded', chatWindow.classList.contains('visible') ? 'true' : 'false');
    });
    ...
    // Focus trap when chat window is opened
    chatWindow.addEventListener('transitionend', () => {
        if (chatWindow.classList.contains('visible')) {
            trapFocus(chatWindow);
            chatWindow.querySelector('.chat-start-btn')?.focus();
        }
    });
})();